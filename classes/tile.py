...
class Tile:
    def __init__(self, position: tuple[int, int, int], is_ocean_tile: bool = False, reserved_by_player: Player | None = None, occupied_with: str | None = None, placement_bonus: Reward | None = None, owner: Player | None = None) -> None:
